  ...
  return (
    <div className="">
      <div className="flex justify-center items-center space-x-3">
        <img src={Image1} className="w-64" alt="img1" />
        <div className="space-y-3">
          <img src={Image2} className="w-20" alt="img2" />
          <img src={Image3} className="w-20" alt="img3" />
          <img src={Image4} className="w-20" alt="img4" />
        </div>
      </div>
      <div className="mx-6 my-3">
        ...
        <div className="flex justify-around items-center">
          ...
          <Button
            ...
            background="bg-[#D9E0EC]/20 hover:bg-indigo-800"
