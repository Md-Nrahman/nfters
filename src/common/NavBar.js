...
const NavBar = () => {
  ...
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
            <span class="ml-3 text-xl integralBold text-indigo-800">NFTERS</span>
    </a>
    ...
    <button class="inline-flex items-center bg-indigo-800 text-white border-0 mr-3 py-2 px-9 focus:outline-none hover:bg-gray-200 rounded-full text-base mt-4 md:mt-0">Upload
          ...
          <button class="inline-flex items-center text-indigo-800 text-white border-2 border-indigo-800 py-2 px-9 focus:outline-none hover:bg-gray-200 rounded-full text-base mt-4 md:mt-0">Connect Wallet
          </button>
  </div>
</header>
  )
